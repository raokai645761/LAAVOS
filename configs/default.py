...
class DefaultEngineConfig():
    def __init__(self, exp_name='default', model='aott'):
        ...
        self.PRETRAIN = True
        self.PRETRAIN_FULL = False  # if False, load encoder only a
    ...
    def init_dir(self):
        ...
        self.DIR_DAVIS = os.path.join(self.DIR_DATA, 'Davis2017-medaka-Ventral')
        ...
        self.DIR_RESULT = os.path.join(self.DIR_ROOT, 'result50000', self.EXP_NAME,
                                       self.STAGE_NAME)
        ...
        self.DIR_EVALUATION = './results50000'
