...
#         print('3333', seqname, imagelist, lablist, index)
#         print('4444', len(imagelist))
#         print('5555', os.path.join(self.image_root, seqname, imagelist[index]))
#         print('7777', imagelist[index])
        image = cv2.imread(
...
#                 print('get ref frame')
                ref_image, ref_label = self.get_image_label(
                    seqname, imagelist, lablist, ref_index)
#                 print('get ref frame done')
                ref_objs = list(np.unique(ref_label))

                # get curr frames
#                 print('get curr frames')
                curr_indices = self.get_curr_indices(lablist, ref_index,
                                                     curr_gaps)
                curr_images, curr_labels, curr_objs = [], [], []
#                 print('6666', curr_indices)
#                 print('777', len(curr_indices))
                for curr_index in curr_indices:
#                     print('1111', seqname)
#                     print('2222', curr_index)
                    curr_image, curr_label = self.get_image_label(
                        seqname, imagelist, lablist, curr_index)
                    c_objs = list(np.unique(curr_label))
                    curr_images.append(curr_image)
